        ...
        children: [
          Container(
            ...
            decoration: const BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(color: Color.fromRGBO(192, 0, 26, 0.25), blurRadius: 40, spreadRadius: 10),
              ],
            ),
          ),
          AnimatedBuilder(
...
class FighterPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final s1 = Paint()..color = const Color(0xFFC0001A)..style = PaintingStyle.stroke..strokeWidth = 1.2;
    final s2 = Paint()..color = const Color(0xFFFF1A2E)..style = PaintingStyle.stroke..strokeWidth = 1.5;
    final f1 = Paint()..color = const Color(0xFF1A0305)..style = PaintingStyle.fill;
    final fRojo = Paint()..color = const Color(0xFFC0001A)..style = PaintingStyle.fill;
    final fSangre = Paint()..color = const Color(0xFF7A0010)..style = PaintingStyle.fill;
    final sPlata = Paint()..color = const Color(0xFFC8BFBF)..style = PaintingStyle.stroke..strokeWidth = 2.5..strokeCap = StrokeCap.round;
    ...
    canvas.drawLine(const Offset(50, 2), const Offset(50, 8), Paint()..color = const Color(0xFFFF1A2E)..strokeWidth = 2);
    ...
    canvas.drawPath(torsoPath, Paint()..color = const Color(0xFFC0001A)..style = PaintingStyle.stroke..strokeWidth = 1);
    ...
    canvas.translate(-35, -38);
    final armPaint = Paint()..color = const Color(0xFFC0001A)..style = PaintingStyle.stroke..strokeWidth = 6..strokeCap = StrokeCap.round;
    ...
    canvas.drawPath(shieldPath, Paint()..color = const Color(0xFFC0001A)..style = PaintingStyle.stroke..strokeWidth = 1);
    final shieldDeco = Paint()..color = const Color(0xFFFF1A2E)..strokeWidth = 1;
    ...
    canvas.drawLine(const Offset(88, 50), const Offset(82, 54), Paint()..color = const Color(0xFFC8BFBF)..style = PaintingStyle.stroke..strokeWidth = 1.5);
    canvas.restore();

    final pLegs = Paint()..color = const Color(0xFF1A0305)..style = PaintingStyle.fill;
    final sLegs = Paint()..color = const Color(0xFFC0001A)..style = PaintingStyle.stroke..strokeWidth = 0.8;
    ...
    canvas.drawPath(emblem, Paint()..color = const Color(0xFFFF1A2E)..style = PaintingStyle.stroke..strokeWidth = 0.8..color = const Color(0xFFFF1A2E).withValues(alpha: 0.7));
